...
public class PaymentConsumerConfig {
    ...
    public ConsumerFactory<String, PaymentRequestDTO> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<String, PaymentRequestDTO>(configMap);
    }
...
//    }
    ...
    @Bean
    KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, PaymentRequestDTO>>

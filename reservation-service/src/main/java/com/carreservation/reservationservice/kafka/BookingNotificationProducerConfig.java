...
@Configuration
@EnableKafka
public class BookingNotificationProducerConfig {


    public ProducerFactory<String, BookingNotification> producerFactory() {
        ...
        return new DefaultKafkaProducerFactory<String, BookingNotification>(configMap);
    }

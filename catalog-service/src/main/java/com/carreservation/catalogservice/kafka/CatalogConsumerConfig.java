...
public class CatalogConsumerConfig {
    public ConsumerFactory<String, CatalogMessageDTO> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<String, CatalogMessageDTO>(configMap);
    }

    @Bean
    KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, CatalogMessageDTO>>
    kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, CatalogMessageDTO> factory =
